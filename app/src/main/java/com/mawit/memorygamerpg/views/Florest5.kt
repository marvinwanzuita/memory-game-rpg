...
class Florest5 : AppCompatActivity() {

    private lateinit var binding: ActivityFlorest5Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFlorest5Binding.inflate(layoutInflater)
    ...
    fun alertInfo() {
        ...
        val view = layoutInflater.inflate(R.layout.alert_dialog_florest5_info, null)
        alertBuilder.setView(view)
